...
string triggerGenerator(assertions asser, string &dec)
{
	...
	dec.insert(dec.find("parameter"), id);
	dec.insert(dec.find("parameter"), "; //Generated by [ TRIGGER ]\n");
	trigger.append("initial begin\n    p");trigger.append(id);trigger.append("=2'b00;\n    n");
	trigger.append(id);trigger.append("=2'b00;\n    tp");
	trigger.append(id);trigger.append("=2'b00;\n    tn");
	trigger.append(id);trigger.append("=2'b00;\n    pstate<=S0;\nend\n");
	...
	trigger.append("end\n");
	trigger.append("always @(clk) begin\n");
	trigger.append("    $display(\"p");trigger.append(id);trigger.append(": %b  en");
	trigger.append(id);trigger.append(": %b  count");
	trigger.append(id);trigger.append(": %b  tp");
	trigger.append(id);trigger.append(": %b  co");
	trigger.append(id);trigger.append(": %b  x");
	trigger.append(id);trigger.append(": %b\",p");
	trigger.append(id);trigger.append(",en");
	trigger.append(id);trigger.append(",count");
	trigger.append(id);trigger.append(",tp");
	trigger.append(id);trigger.append(",co");
	trigger.append(id);trigger.append(",x");
	trigger.append(id);trigger.append(");\n");
	trigger.append("end\n");
	trigger.append("\n");
	...
	if(asser.trigger) //positive
	{
		...
		trigger.append("always @(");trigger.append(asser.triSignal);trigger.append(" or ");trigger.append(p); trigger.append(") begin\n");		trigger.append("    case ("); trigger.append(p); trigger.append(")\n");
