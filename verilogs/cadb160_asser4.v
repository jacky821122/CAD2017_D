...
always @(in or p) begin
    case (p)
    2'b00: casex(out[0])
        1'b1: begin n=2'b01; en=1'b0; end
        1'b0: begin n=2'b00; en=1'b0; end
        endcase
    2'b01: casex(out[0])
        1'b1: begin n=2'b01; en=1'b0; end
        1'b0: case(PPI)
...
always @(count) begin
    if(count>=6'b011101) begin
        if(count<=6'b011111) //delaySecond: 32     bit: 6
            co=1;
        else begin
            co=0;
        end
