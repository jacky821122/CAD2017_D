module fsm(clk, rst, in, PPI9, z9);
input clk, rst;
input [6:0] in;
reg [6:0] out;
reg [6:0] pstate, nstate;
reg [1:0] p9, n9; //Generated by [ TRIGGER ]
reg en9; //Generated by [ TRIGGER ]
reg [2:0] count9; //Generated by [ COUNTER ]
input PPI9; //Generated by [ COUNTER ]
reg [1:0] tp9,tn9; //Generated by [ DETECTOR ]
output reg z9; //Generated by [ DETECTOR ]
reg co9; //Generated by [ DETECTOR ]
reg r9; //Generated by [ RESET ]
reg [1:0] rp9, rn9; //Generated by [ RESET ]
...
always @(in or p9) begin
    case (p9)
    2'b00: casex(out[0])
        1'b0: begin n9=2'b01; en9=1'b0; end
        1'b1: begin n9=2'b00; en9=1'b0; end
        endcase
    2'b01: casex(out[0])
        1'b0: begin n9=2'b01; en9=1'b0; end
        1'b1: case(PPI9)
            1'b0: begin n9=2'b10; en9=1'b0; end
            1'b1: begin n9=2'b11; en9=1'b1; end
            endcase
        endcase
    2'b10: casex(out[0])
        1'b0: begin n9=2'b01; en9=1'b0; end
        1'b1: begin n9=2'b10; en9=1'b0; end
        endcase
    2'b11: begin n9=2'b11; en9=1'b1; end
    endcase
end
...
always @(out[5] or tp9 or co9) begin
    case (tp9)
    2'b00: casex(co9&en9)
        1'b0: begin tn9=2'b00; z9=0;end
        1'b1: begin tn9=2'b01; z9=0;end
        endcase
    2'b01: if(~co9) begin tn9=2'b01; z9=1;end
        else casex(out[5])
        1'b1: begin tn9=2'b10; z9=~co9;end
        1'b0: begin tn9=2'b01; z9=~co9;end
        endcase
    2'b10: if(~co9) begin tn9=2'b01; z9=1;end
        else casex(out[5])
        1'b1: begin tn9=2'b10; z9=~co9;end
        1'b0: begin tn9=2'b11; z9=0;end
        endcase
    2'b11: casex(out[5])
        1'b0: begin tn9=2'b11; z9=0;end
        1'b1: begin tn9=2'b11; z9=0;end
        endcase
    endcase
end
...
always @(*) begin
    case(rp9)
    S0: case(rst)
        1'b0: begin rn9=S1; r9=0; end
        1'b1: begin rn9=S0; r9=0; end
        endcase
    S1: case(rst)
        1'b0: begin rn9=S1; r9=0; end
        1'b1: begin rn9=S2; r9=1; end
        endcase
    S2: case(rst)
        1'b0: begin rn9=S1; r9=0; end
        1'b1: begin rn9=S2; r9=0; end
        endcase
    S3: begin rn9=S3; r9=0; end
    endcase
end
