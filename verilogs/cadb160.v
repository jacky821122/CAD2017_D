...
always @(clk) begin
    $display("p1: %b  en1: %b  count1: %b  tp1: %b  co1: %b  x1: %b",p1,en1,count1,tp1,co1,x1);
end

always @(in[6] or p1) begin
    case (p1)
    2'b00: casex(in[6])
...
always @(clk) begin
    $display("p3: %b  en3: %b  count3: %b  tp3: %b  co3: %b  x3: %b",p3,en3,count3,tp3,co3,x3);
end

always @(out[0] or p3) begin
    case (p3)
    2'b00: casex(out[0])
...
always @(clk) begin
    $display("p5: %b  en5: %b  count5: %b  tp5: %b  co5: %b  x5: %b",p5,en5,count5,tp5,co5,x5);
end

always @(out[3] or p5) begin
    case (p5)
    2'b00: casex(out[3])
...
always @(clk) begin
    $display("p6: %b  en6: %b  count6: %b  tp6: %b  co6: %b  x6: %b",p6,en6,count6,tp6,co6,x6);
end

always @(in[0] or p6) begin
    case (p6)
    2'b00: casex(in[0])
...
always @(clk) begin
    $display("p7: %b  en7: %b  count7: %b  tp7: %b  co7: %b  x7: %b",p7,en7,count7,tp7,co7,x7);
end

always @(out[0] or p7) begin
    case (p7)
    2'b00: casex(out[0])
...
always @(clk) begin
    $display("p8: %b  en8: %b  count8: %b  tp8: %b  co8: %b  x8: %b",p8,en8,count8,tp8,co8,x8);
end

always @(out[6] or p8) begin
    case (p8)
    2'b00: casex(out[6])
...
always @(clk) begin
    $display("p10: %b  en10: %b  count10: %b  tp10: %b  co10: %b  x10: %b",p10,en10,count10,tp10,co10,x10);
end

always @(out[1] or p10) begin
    case (p10)
    2'b00: casex(out[1])
