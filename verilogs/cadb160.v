...
reg last_in6_1, en1, en_n1; //Generated by [ TRIGGER ]
reg [2:0] count1; //Generated by [ COUNTER ]
reg last_out1_1, detect1, detect_n1, clk_start1, clk_start_n1, co1; //Generated by [ DETECTOR ]
reg last_in5_2, en2, en_n2; //Generated by [ TRIGGER ]
reg [3:0] count2; //Generated by [ COUNTER ]
reg last_out6_2, detect2, detect_n2, clk_start2, clk_start_n2, co2; //Generated by [ DETECTOR ]
reg last_out0_3, en3, en_n3; //Generated by [ TRIGGER ]
reg [5:0] count3; //Generated by [ COUNTER ]
reg last_out5_3, detect3, detect_n3, clk_start3, clk_start_n3, co3; //Generated by [ DETECTOR ]
reg last_out0_4, en4, en_n4; //Generated by [ TRIGGER ]
reg [5:0] count4; //Generated by [ COUNTER ]
reg last_out5_4, detect4, detect_n4, clk_start4, clk_start_n4, co4; //Generated by [ DETECTOR ]
reg last_out3_5, en5, en_n5; //Generated by [ TRIGGER ]
reg [2:0] count5; //Generated by [ COUNTER ]
reg last_out4_5, detect5, detect_n5, clk_start5, clk_start_n5, co5; //Generated by [ DETECTOR ]
reg last_in0_6, en6, en_n6; //Generated by [ TRIGGER ]
reg [4:0] count6; //Generated by [ COUNTER ]
reg last_out2_6, detect6, detect_n6, clk_start6, clk_start_n6, co6; //Generated by [ DETECTOR ]
reg last_out0_7, en7, en_n7; //Generated by [ TRIGGER ]
reg [3:0] count7; //Generated by [ COUNTER ]
reg last_out1_7, detect7, detect_n7, clk_start7, clk_start_n7, co7; //Generated by [ DETECTOR ]
reg last_out6_8, en8, en_n8; //Generated by [ TRIGGER ]
reg [2:0] count8; //Generated by [ COUNTER ]
reg last_out6_8, detect8, detect_n8, clk_start8, clk_start_n8, co8; //Generated by [ DETECTOR ]
reg last_out0_9, en9, en_n9; //Generated by [ TRIGGER ]
reg [2:0] count9; //Generated by [ COUNTER ]
reg last_out5_9, detect9, detect_n9, clk_start9, clk_start_n9, co9; //Generated by [ DETECTOR ]
reg last_out1_10, en10, en_n10; //Generated by [ TRIGGER ]
reg [3:0] count10; //Generated by [ COUNTER ]
reg last_out2_10, detect10, detect_n10, clk_start10, clk_start_n10, co10; //Generated by [ DETECTOR ]
...
always @(posedge clk or posedge rst) begin
    if(rst) begin en1 <= 0; last_in6_1 <= 0; end
    else begin
        en1 <= en_n1;
        last_in6_1 <= in[6];
    end
...
assign en_n1 = en1 | ((~last_in6_1 & in[6]) & PPI1);
...
always @(posedge clk or posedge rst) begin
    if(rst) begin last_out1_1 <= 0; detect1 <= 0; clk_start1 <= 0; end
    else
    begin
        last_out1_1 <= out[1];
...
assign detect_n1 = detect1 | (~last_out1_1 & out[1]);
assign clk_start_n1 = clk_start1 | co1;
assign z1 = (~detect1 & (clk_start1 & ~co1));

always @(posedge clk or posedge rst) begin
    if(rst) begin en2 <= 0; last_in5_2 <= 0; end
    else begin
        en2 <= en_n2;
        last_in5_2 <= in[5];
    end
...
assign en_n2 = en2 | ((last_in5_2 & ~in[5]) & PPI2);
...
always @(posedge clk or posedge rst) begin
    if(rst) begin last_out6_2 <= 0; detect2 <= 0; clk_start2 <= 0; end
    else
    begin
        last_out6_2 <= out[6];
...
assign detect_n2 = detect2 | (~last_out6_2 & out[6]);
assign clk_start_n2 = clk_start2 | co2;
assign z2 = (~detect2 & (clk_start2 & ~co2));

always @(posedge clk or posedge rst) begin
    if(rst) begin en3 <= 0; last_out0_3 <= 0; end
    else begin
        en3 <= en_n3;
        last_out0_3 <= out[0];
    end
...
assign en_n3 = en3 | ((last_out0_3 & ~out[0]) & PPI3);
...
always @(posedge clk or posedge rst) begin
    if(rst) begin last_out5_3 <= 0; detect3 <= 0; clk_start3 <= 0; end
    else
    begin
        last_out5_3 <= out[5];
...
assign detect_n3 = detect3 | (~last_out5_3 & out[5]);
assign clk_start_n3 = clk_start3 | co3;
assign z3 = (~detect3 & (clk_start3 & ~co3));

always @(posedge clk or posedge rst) begin
    if(rst) begin en4 <= 0; last_out0_4 <= 0; end
    else begin
        en4 <= en_n4;
        last_out0_4 <= out[0];
    end
...
assign en_n4 = en4 | ((last_out0_4 & ~out[0]) & PPI4);
...
always @(posedge clk or posedge rst) begin
    if(rst) begin last_out5_4 <= 0; detect4 <= 0; clk_start4 <= 0; end
    else
    begin
        last_out5_4 <= out[5];
...
assign detect_n4 = detect4 | (~last_out5_4 & out[5]);
assign clk_start_n4 = clk_start4 | co4;
assign z4 = (~detect4 & (clk_start4 & ~co4));

always @(posedge clk or posedge rst) begin
    if(rst) begin en5 <= 0; last_out3_5 <= 0; end
    else begin
        en5 <= en_n5;
        last_out3_5 <= out[3];
    end
...
assign en_n5 = en5 | ((~last_out3_5 & out[3]) & PPI5);
...
always @(posedge clk or posedge rst) begin
    if(rst) begin last_out4_5 <= 0; detect5 <= 0; clk_start5 <= 0; end
    else
    begin
        last_out4_5 <= out[4];
...
assign detect_n5 = detect5 | (~last_out4_5 & out[4]);
assign clk_start_n5 = clk_start5 | co5;
assign z5 = (~detect5 & (clk_start5 & ~co5));

always @(posedge clk or posedge rst) begin
    if(rst) begin en6 <= 0; last_in0_6 <= 0; end
    else begin
        en6 <= en_n6;
        last_in0_6 <= in[0];
    end
...
assign en_n6 = en6 | ((~last_in0_6 & in[0]) & PPI6);
...
always @(posedge clk or posedge rst) begin
    if(rst) begin last_out2_6 <= 0; detect6 <= 0; clk_start6 <= 0; end
    else
    begin
        last_out2_6 <= out[2];
...
assign detect_n6 = detect6 | (~last_out2_6 & out[2]);
assign clk_start_n6 = clk_start6 | co6;
assign z6 = (~detect6 & (clk_start6 & ~co6));

always @(posedge clk or posedge rst) begin
    if(rst) begin en7 <= 0; last_out0_7 <= 0; end
    else begin
        en7 <= en_n7;
        last_out0_7 <= out[0];
    end
...
assign en_n7 = en7 | ((last_out0_7 & ~out[0]) & PPI7);
...
always @(posedge clk or posedge rst) begin
    if(rst) begin last_out1_7 <= 0; detect7 <= 0; clk_start7 <= 0; end
    else
    begin
        last_out1_7 <= out[1];
...
assign detect_n7 = detect7 | (~last_out1_7 & out[1]);
assign clk_start_n7 = clk_start7 | co7;
assign z7 = (~detect7 & (clk_start7 & ~co7));

always @(posedge clk or posedge rst) begin
    if(rst) begin en8 <= 0; last_out6_8 <= 0; end
    else begin
        en8 <= en_n8;
        last_out6_8 <= out[6];
    end
...
assign en_n8 = en8 | ((last_out6_8 & ~out[6]) & PPI8);
...
always @(posedge clk or posedge rst) begin
    if(rst) begin last_out6_8 <= 0; detect8 <= 0; clk_start8 <= 0; end
    else
    begin
        last_out6_8 <= out[6];
...
assign detect_n8 = detect8 | (last_out6_8 & ~out[6]);
assign clk_start_n8 = clk_start8 | co8;
assign z8 = (~detect8 & (clk_start8 & ~co8));

always @(posedge clk or posedge rst) begin
    if(rst) begin en9 <= 0; last_out0_9 <= 0; end
    else begin
        en9 <= en_n9;
        last_out0_9 <= out[0];
    end
...
assign en_n9 = en9 | ((~last_out0_9 & out[0]) & PPI9);
...
always @(posedge clk or posedge rst) begin
    if(rst) begin last_out5_9 <= 0; detect9 <= 0; clk_start9 <= 0; end
    else
    begin
        last_out5_9 <= out[5];
...
assign detect_n9 = detect9 | (last_out5_9 & ~out[5]);
assign clk_start_n9 = clk_start9 | co9;
assign z9 = (~detect9 & (clk_start9 & ~co9));

always @(posedge clk or posedge rst) begin
    if(rst) begin en10 <= 0; last_out1_10 <= 0; end
    else begin
        en10 <= en_n10;
        last_out1_10 <= out[1];
    end
...
assign en_n10 = en10 | ((last_out1_10 & ~out[1]) & PPI10);
...
always @(posedge clk or posedge rst) begin
    if(rst) begin last_out2_10 <= 0; detect10 <= 0; clk_start10 <= 0; end
    else
    begin
        last_out2_10 <= out[2];
...
assign detect_n10 = detect10 | (~last_out2_10 & out[2]);
