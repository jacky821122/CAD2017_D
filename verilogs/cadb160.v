module fsm(clk, rst, PPI1, PPI2, PPI3, PPI4, PPI5, PPI6, PPI7, PPI8, PPI9, PPI10, X, in);
input clk, rst;
input [6:0] in;
reg [6:0] out;
...
reg r; //Generated by [ RESET ]
reg [1:0] rp, rn; //Generated by [ RESET ]
reg x1, x2, x3, x4, x5, x6, x7, x8, x9, x10;
output X;
assign X = x1&x2&x3&x4&x5&x6&x7&x8&x9&x10;
always @(*) begin
    if(z1==1) x1=1;
    else x1=0;
    if(z2==1) x2=1;
