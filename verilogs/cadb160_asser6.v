module fsm(clk, rst, in, PPI, z);
input clk, rst;
input [6:0] in;
reg [6:0] out;
reg [6:0] pstate, nstate;
reg [1:0] p,n; //Generated by us
reg en; //Generated by us
reg [4:0] count; //Generated by us
input PPI; //Generated by us
reg [1:0] tp,tn; //Generated by us
output reg z; //Generated by us
reg co; //Generated by us
...
always @(in or p) begin
    case (p)
    2'b00: casex(in[0])
        1'b0: begin n=2'b01; en=1'b0; end
        1'b1: begin n=2'b00; en=1'b0; end
        endcase
    2'b01: casex(in[0])
        1'b0: begin n=2'b01; en=1'b0; end
        1'b1: case(PPI)
            1'b0: begin n=2'b10; en=1'b0; end
            1'b1: begin n=2'b11; en=1'b1; end
            endcase
        endcase
    2'b10: casex(in[0])
        1'b0: begin n=2'b01; en=1'b0; end
        1'b1: begin n=2'b10; en=1'b0; end
        endcase
    2'b11: begin n=2'b11; en=1'b1; end
    endcase
end
...
always @(count) begin
    if(count>=5'b10011) begin
        if(count<=5'b11010) //delaySecond: 27     bit: 5
            co=1;
        else begin
            co=0;
        end
...
always @(out[2] or tp or co) begin
    case (tp)
    2'b00: casex(co&en)
        1'b0: begin tn=2'b00; z=0;end
        1'b1: begin tn=2'b01; z=0;end
        endcase
    2'b01: casex(out[2])
        1'b0: begin tn=2'b10; z=~co;end
        1'b1: begin tn=2'b01; z=~co;end
        endcase
    2'b10: casex(out[2])
        1'b0: begin tn=2'b10; z=~co;end
        1'b1: begin tn=2'b11; z=0;end
        endcase
    2'b11: casex(out[2])
        1'b0: begin tn=2'b11; z=0;end
        1'b1: begin tn=2'b11; z=0;end
        endcase
    endcase
end
